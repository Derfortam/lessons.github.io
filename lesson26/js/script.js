...
const image = document.querySelector('.swipe__main-image')
const text = document.querySelector('.swipe__description')

function documentAction(e) {
    const targetElement = e.target
    if (targetElement.closest('.swipe__arrow-left')) {
        image.src = swipeObj.slide1.img
        text.textContent = swipeObj.slide1.description
    }
    if (targetElement.closest('.swipe__arrow-right')) {
        image.src = swipeObj.slide2.img
        text.textContent = swipeObj.slide2.description
    }
}
